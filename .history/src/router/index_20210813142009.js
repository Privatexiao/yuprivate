...
// import GuoLuQi from '@/components/tovue/GuoLuQi'
import BianLiShuZu from '@/components/tovue/BianLiShuZu'
import GouWuChe from '@/components/tovue/GouWuChe'
import JiSuanFangFa from '@/components/tovue/JiSuanFangFa'
import JiSuanShuXing from '@/components/tovue/JiSuanShuXing'
...
export default new Router({
  routes: [
    ...
    // 遍历数组
    {
      path: '/tovue/BianLiShuZu',
      name: 'BianLiShuZu',
      component: BianLiShuZu
    },
    // 购物车实例
    {
      path: '/tovue/GouWuChe',
    ...
    // Vue计算方法
    {
      path: '/tovue/JiSuanFangFa',
      name: 'JiSuanFangFa',
      component: JiSuanFangFa
    },
    // Vue计算属性
    {
      path: '/tovue/JiSuanShuXing',
      name: 'JiSuanShuXing',
