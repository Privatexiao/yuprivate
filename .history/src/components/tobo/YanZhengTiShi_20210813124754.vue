		...
		<div class="col-md-6 col-md-offset-3">
			<form action="" method="get">
				<div class="form-group has-feedback">
					...
					<span style="color: red; float:left">用户名不存在</span>
				</div>
				<div class="form-group has-feedback">
					...
					<span style="color: red; float:left">密码不能为空</span>
				</div>
				...
				<div class="form-group has-feedback">
					...
					<span style="color: red; float:left">密码不一致</span>
				</div>
				<div class="row">
					<div class="col-xs-7">
						<div class="form-group has-feedback">
							<label for="idcode-btn" style="color: red; float:left">验证码</label>
